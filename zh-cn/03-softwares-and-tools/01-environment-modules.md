...
| gmpich | GCC, MPICH                              | ***2016a*** (3.2)<br />2017.08 (3.2.1)<br />***2017o*** (3.2.1) | gcc编译的MPICH   |
| impich | icc, ifort, MPICH                       | ***2018o*** (3.2.1)                                          | icc编译的MPICH   |
| gompi  | GCC, OpenMPI                            | 1.5.16 (1.6.5)<br />***2016b*** (1.10.3)<br />***2018a*** (2.1.2)<br />2018b (3.1.1)<br />***2018o*** (3.1.3)<br />2019a (3.1.3)<br />***2019o*** (4.0.0) | gcc编译的OpenMPI |
...
- 在实验室集群上，用 intel 的工具链编译的程序一般都比用 gnu 的要快，因此，在目前版本有效期内，推荐使用 intel/impich/iompi 这几个工具链；
- 对于一个工具链，如果你不确定要用什么版本，可以选择表中加粗字体的版本，例如以 '***o***' 结尾的版本。
